...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('mitra_md', {
    id_mitra: {
      autoIncrement: true,
    ...
    jenis_produk: {
      ...
      allowNull: true,
      defaultValue: "[]",
      comment: "['Pesawat','Rental Mobil','Rental Motor','Rental Bus','Kapal Laut','Kereta Api','Hotel','Apartment','Villa','MICE','Outbound','Tiket Acara','Restoran','Sport','Tour','Visa','Paspor']"
    },
    wilayah: {
